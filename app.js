...
class Controller{
    ...
    handleAddToCart() {
        if(this.model.sneaker.quantity === 0){
            return;
        } else {
        ...
        sneakerCont.innerHTML = `
            <div class="sneaker-image-container">
                ...
                <div class="thumbnail-container">
                    <img class="sneaker-thumbnail" src="${obj.images.thumbnails[0]}" alt="Image of sneaker">
                    <img class="sneaker-thumbnail" src="${obj.images.thumbnails[1]}" alt="Image of sneaker">
                    <img class="sneaker-thumbnail" src="${obj.images.thumbnails[2]}" alt="Image of sneaker">
                    <img class="sneaker-thumbnail" src="${obj.images.thumbnails[3]}" alt="Image of sneaker">
                </div>
            </div>
            ...
            <div class="sneaker-text-container">
                ...
                <div class=sneaker-button-container>
                ...
                <div class="cart-rule"></div>
                    <div class="cart-item-container">
                        ...
                        <div class = "cart-sneaker-text">
                            ...
                            <p class="cart-price-and-total">$${cart.items[0].salePrice} x ${cart.total}</p> <p class="cart-total-price">$${cart.total*sneaker.salePrice}</p>
                        </div>
